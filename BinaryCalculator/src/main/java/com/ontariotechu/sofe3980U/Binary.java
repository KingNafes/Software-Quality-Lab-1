...
public class Binary
{
	...
	*/
	...
	/**
	 * Computes the bitwise OR of two binary numbers.
	 *
	 * @param num1 The first binary number.
	 * @param num2 The second binary number.
	 * @return A binary number representing the bitwise OR of <i>num1</i> and <i>num2</i>.
	 */
	public static Binary or(Binary num1, Binary num2) {
		...
		char[] result = new char[bigger.length()];
		...
		for (int i = 0; i < smaller.length(); ++i) {
			...
			result[difference + i] = (bit1 | bit2) == 1 ? '1' : '0';
		}

		return new Binary(String.valueOf(result));
	}
