...
public class BinaryTest
{
    ...
    */
    ...
    public void and()
    {
        Binary binary1=new Binary("100001");
        Binary binary2=new Binary("1111");
    ...
    public void multiply2()
    {
        ...
        Binary binary2=new Binary("1111");
        Binary binary3=Binary.multiply(binary1,binary2);
        assertTrue( binary3.getValue().equals("100111011"));
    }
    /**
    ...
    {
        Binary binary1=new Binary("11000");
        Binary binary2=new Binary("10000");
        Binary binary3=Binary.multiply(binary1,binary2);
        assertTrue( binary3.getValue().equals("110000000"));
    }
}
